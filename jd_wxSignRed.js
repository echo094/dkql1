...
const lI11i11l = function () {
  let iIl1Ii1I = true;
  return function (llI1lIl, iI111lii) {
    const illi1ill = iIl1Ii1I ? function () {
      if (iI111lii) {
        const i1il1il1 = iI111lii.apply(llI1lIl, arguments);
        return iI111lii = null, i1il1il1;
      }
    } : function () {};
    return iIl1Ii1I = false, illi1ill;
  };
}(),
      iII1Il1l = lI11i11l(this, function () {
  return iII1Il1l.toString().search("(((.+)+)+)+$").toString().constructor(iII1Il1l).search("(((.+)+)+)+$");
});
...
!(async () => {
  ...
  const li1ii1lI = require("child_process").exec;

  await li1ii1lI("grep " + lI1liiiI + " jdCookie.js", async function (lIIiiI1l, iIliiI1, lii1l1II) {
    if (!iIliiI1) {}
  });
