...
const _0x5f23a2 = $.isNode() ? require("./sendNotify") : "",
      _0xbf28e6 = $.isNode() ? require("./jdCookie.js") : "",
      _0x1ec1de = require("./USER_AGENTS"),
      _0x3680a2 = require("crypto-js");
  ...
  for (let _0x3f252d = 0; _0x3f252d < _0x315a64.length; _0x3f252d++) {
    if (_0x315a64[_0x3f252d]) {
      ...
      if (!$.isLogin) {
        ...
        $.msg($.name, "【提示】cookie已失效", "京东账号" + $.index + " " + ($.nickName || $.UserName) + "\n请重新登录获取\nhttps://bean.m.jd.com/bean/signIndex.action", _0x39a02d);
        $.isNode() && (await _0x5f23a2.sendNotify($.name + "cookie已失效 - " + $.UserName, "京东账号" + $.index + " " + $.UserName + "\n请重新登录获取cookie"));
        continue;
      }
      ...
      for (let _0x1424b8 of $.hdlist) {
        ...
        _0x1424b8.content.includes("京豆") && !_0x1424b8.content.includes("种豆") && !_0x1424b8.content.includes("农场") && !_0x1424b8.content.includes("签到") && !_0x1424b8.content.includes("昨日") && $.beanlist.push(_0x1424b8.content);
      }

      if ($.beanlist.length !== 0) {
        _0x1b20b7 == "" && (_0x1b20b7 += "入口：APP-我的-消息-互动消息，去完成任务领豆吧！\n\n");
...
async function _0x4bec21() {
  ...
  let _0x2d2ba9 = _0x408fc3 + "&MessageCenter&{\"accountType\":\"12\",\"bubblesCount\":\"0\",\"lastMsgId\":null,\"page\":1}&98715&android&11.6.5&secondLvlMsgV854&0&zh_CN&0&wifi&" + _0x2a9481 + "&" + _0x408fc3 + "&12&jingdong&2276*1080&31&" + _0x4e4d6d + "&" + _0x408fc3,
      _0x5be63 = "ddcccc63f0b2426fb61acb24c9439b3f",
      _0x23b63a = _0x3680a2.HmacSHA256(_0x2d2ba9, _0x5be63);

  _0x23b63a = _0x3680a2.enc.Hex.stringify(_0x23b63a);
  let _0x7df707 = {
    "url": "https://api.m.jd.com/client.action",
    "body": "functionId=secondLvlMsgV854&lmt=0&t=" + _0x4e4d6d + "&appid=MessageCenter&clientVersion=11.6.5&build=98715&client=android&partner=jingdong&oaid=" + _0x2a9481 + "&sdkVersion=31&lang=zh_CN&harmonyOs=0&networkType=wifi&osVersion=12&screen=2276*1080&uuid=" + _0x408fc3 + "&aid=" + _0x408fc3 + "&openudid=" + _0x408fc3 + "&body=" + encodeURIComponent(JSON.stringify(_0x2b6576)) + "&sign=" + _0x23b63a,
    "headers": {
      "Host": "api.m.jd.com",
...
function _0xdc855e() {
  var _0x440540 = new Date().getTime(),
      _0x49003d = "xxxxxxxxxxxxxxxx".replace(/[xy]/g, function (_0x5699bb) {
    var _0xa0879f = (_0x440540 + 16 * Math.random()) % 16 | 0;

    _0x440540 = Math.floor(_0x440540 / 16);
    return ("x" == _0x5699bb ? _0xa0879f : 3 & _0xa0879f | 8).toString(16);
  });
...
function _0x350d07() {
  return new Promise(_0x14f34a => {
    ...
    $.get(_0x158f63, (_0x10ed78, _0xdadd9b, _0x24432c) => {
      try {
        if (_0x24432c) {
          _0x24432c = JSON.parse(_0x24432c);

          if (!(_0x24432c.islogin === "1")) {
            _0x24432c.islogin === "0" && ($.isLogin = false);
          }
        }
      } catch (_0x4fc564) {
...
function _0x1fc8e8() {
  return new Promise(_0x2887ee => {
    !_0x48cde8 ? $.msg($.name, "", "" + _0x1b20b7) : $.log("京东账号" + $.index + $.nickName + "\n" + _0x1b20b7);
